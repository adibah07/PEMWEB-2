    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600 mt-1">Kelola jadwal mata kuliah yang Anda ampu</p>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $dosen->matakuliah->count() }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                <div class="p-3 bg-yellow-100 rounded-lg">
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        {{ $jadwals->where('tanggal', today()->format('Y-m-d'))->count() }}
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">Mulai dengan membuat jadwal pertama Anda.</p>
                <div class="mt-6">
                    <a href="{{ route('jadwal.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
