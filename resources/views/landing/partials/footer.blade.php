<footer id="contact" class="bg-gray-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center mb-4">
                        ...
                        <span class="ml-3 text-xl font-bold">ClassAttend</span>
                    </div>
                    <p class="text-gray-400 mb-4 max-w-md">
                        Solusi absensi digital terdepan untuk institusi pendidikan modern. Mudah, aman, dan efisien.
                    </p>
                ...
                <!-- Links -->
                <div>
                    <h4 class="text-lg font-semibold mb-4">Produk</h4>                    <ul class="space-y-2">
            ...
            <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2025 ClassAttend. Semua hak dilindungi undang-undang.</p>
            </div>
        </div>
    </footer>