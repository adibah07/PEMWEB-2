<div>
    ...
    <div class="container mx-auto">
        ...
        <div class="flex justify-between mb-4">
            <flux:button :href="route('pegawai.create')" variant="primary">New Ruang</flux:button>
        </div>
            ...
            <tbody>
                @foreach ($pegawais as $pegawai)
                    <tr>
                        ...
                        <td class="py-2 px-4 border border-gray-300">{{ $pegawai->unitKerja->nama ?? 'Tidak Ada' }}</td>
