                ...
                @foreach ($units as $unit)
                    <tr>
                        ...
                        <td class="py-2 px-4 border border-gray-300">
                            <flux:button :href="route('unitkerja.edit', $unit->id)">Edit</flux:button>
                            <flux:button variant="danger" wire:click="delete({{ $unit->id }})" wire:confirm="Hapus Unit Kerja ini?">Delete</flux:button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
