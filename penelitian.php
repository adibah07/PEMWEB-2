...
<button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#tambahModal">tambah data</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="tambahModalLabel">Tambah Data Penelitian</h5>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                                ...
                                <textarea class="form-control" id="kegiatan" name="kegiatan" placeholder="kegiatan" required></textarea>
                            </div>
